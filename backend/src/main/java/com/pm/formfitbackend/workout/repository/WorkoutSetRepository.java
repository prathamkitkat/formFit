...
public interface WorkoutSetRepository extends JpaRepository<WorkoutSet, Long> {
    ...
    LIMIT 1
    """, nativeQuery = true)
    Object[] getHeaviestWeight(Long userId, Long exerciseId);
    ...
    LIMIT 1
    """, nativeQuery = true)
    Object[] getBest1RM(Long userId, Long exerciseId);
    ...
    LIMIT 1
    """, nativeQuery = true)
    Object[] getBestSetVolume(Long userId, Long exerciseId);
    ...
    LIMIT 1
    """, nativeQuery = true)
    Object[] getBestSessionVolume(Long userId, Long exerciseId);
}